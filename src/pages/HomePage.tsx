...
export function HomePage() {
  ...
  const configsCount = useConfigStore(state => state.configs.length);
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 overflow-hidden relative font-sans">
      ...
      <main className="max-w-2xl w-full mx-auto flex flex-col items-center justify-center space-y-8 z-10 animate-fade-in">
